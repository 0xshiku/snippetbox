...
func newTestDB(t *testing.T) *sql.DB {
	...
	// Use the t.Cleanup() to register a function, which will automatically be called by Go when the current test (or sub-test) which calls newTestDB() has finished
